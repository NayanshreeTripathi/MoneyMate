...
import { ChevronDown, ChevronUp, Clock, MoreHorizontal, RefreshCcw, Search, X } from 'lucide-react';
...
const TransactionsTable = ({ transactions }) => {
    ...
    const handleBulkDelete = async () => {
        if (
            !window.confirm(
                `Are you sure you want to delete ${selectedIds.length} transactions?`)) { return; }
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Transaction Table */}
            <div className='rounde-md border'>
                <Table>
                    ...
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="cursor-pointer" onClick={() => handleSort('amount')}>
                                <div className='flex items-center'>Amount {sortedConfig.field === 'amount' && (
                                    sortedConfig.direction === 'asc' ? <ChevronUp className='ml-1 h-4 w-4' /> : <ChevronDown className='ml-1 h-4 w-4' />
                                )}</div>
                            </TableHead>
                                    ...
                                    <TableCell>
                                        {transaction.isRecurring ? (
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger>
                                                        <Badge variant='outline' className='gap-1 bg-teal-100 text-teal-700 hover:bg-teal-200'>
